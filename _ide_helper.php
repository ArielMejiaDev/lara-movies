 ...
 */
     ...
     */
        ...
        public static function critical($message, $context = [])
        {
                    ...
                    /**
         * Runtime errors that do not require immediate Actions but should typically
     ...
     */
        ...
        public static function temporarySignedRoute($route, $expiration, $parameters = [], $status = 302, $headers = [])
        {
                    ...
                    /**
         * Create a new redirect response to a controller Actions.
         *
     ...
     */
        ...
        public static function uses(...$patterns)
        {
                    ...
                    /**
         * Determine if the current route Actions matches a given Actions.
         *
         * @param string $action
         * @return bool
         * @static
...
')
     ...
     */
        ...
        public static function toRoute($route, $parameters, $absolute)
        {
                    ...
                    /**
         * Get the URL to a controller Actions.
         *
         * @param string|array $action
         * @param mixed $parameters
         * @param bool $absolute
